/*
  btt_skr_e3-DIP_1.1_map.h - driver code for STM32F103RC ARM processors
...
#else
#define BOARD_NAME "BTT SKR E3-DIP V1.1"
#endif
...
#define Z_ENABLE_PIN            11  //PB11

// Define homing/hard limit switch input pins.
#define LIMIT_PORT              GPIOC
#define X_LIMIT_PIN             1 //PC1
#define Y_LIMIT_PIN             0 //PC0
#define Z_LIMIT_PIN             15 //PC15
